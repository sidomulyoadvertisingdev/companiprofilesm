      ...
      <section className="py-32 bg-[#f5f5f7]">
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-3 gap-12">
          ...
          >
            ...
            <p className="text-[#6e6e73] mb-4">0888 0888 8880</p>
            <a href="https://wa.me/6288808888880" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
              Chat Sekarang
            </a>
          </motion.div>
          ...
          >
            ...
            <p className="text-[#6e6e73] mb-4">sosmedsidomulyo@gmail.com</p>
            <a href="mailto:sosmedsidomulyo@gmail.com" className="text-blue-600 hover:underline">
              Kirim Email
            </a>
          </motion.div>
      ...
      <section className="py-32 bg-[#f5f5f7]">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <form className="space-y-6">
            <input type="text" placeholder="Nama" className="w-full px-6 py-4 rounded-xl border focus:outline-none" />
            <input type="email" placeholder="Email" className="w-full px-6 py-4 rounded-xl border focus:outline-none" />
            <textarea placeholder="Pesan" rows="5" className="w-full px-6 py-4 rounded-xl border focus:outline-none" />
            <button
              type="submit"
